...
import (
	...
	"github.com/lucoadam/go-ethereum/cmd/utils"
	...
	"github.com/lucoadam/go-ethereum/ethclient"
	"github.com/lucoadam/go-ethereum/ethstats"
	"github.com/lucoadam/go-ethereum/internal/version"
...
func (f *faucet) apiHandler(w http.ResponseWriter, r *http.Request) {
	...
	for {
		...
		default:
			//lint:ignore ST1005 This error is to be displayed in the browser
			err = errors.New("Something funky happened, please open an issue at https://github.com/lucoadam/go-ethereum/issues")
		}
		if err != nil {
			if err = sendError(wsconn, err); err != nil {
